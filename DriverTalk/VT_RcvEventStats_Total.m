function f=VT_RcvEventStats_Total(nHighWay, bDense, fEndTime, mImgSize)
...
%    sNeighFilePre = 'Sparse_sp_NeighborList_Trans\\aligned\\Sparse_Neighbor';
    ...
    if nHighWay == 1
        sProcessedTraceFilePre = 'Sparse_sp_Trace\\VT_Highway_Sparse';
    else
        sProcessedTraceFilePre = 'Sparse_sp_Trace\\VT_City_Sparse';
    end
...
%    sNeighFilePre = 'Dense_sp_NeighborList_Trans\\aligned\\Dense_Neighbor';
    ...
    if nHighWay == 1
        sProcessedTraceFilePre = 'Dense_sp_Trace\\VT_Highway_Dense';
    else
        sProcessedTraceFilePre = 'Dense_sp_Trace\\VT_City_Dense';        
    end
