function f = SS_PlotSimilarityConfMatrix_Crowdsource(sFile)
...
xLabels = 'Crowdsourced Stores';
yLabels = 'Crowdsourced Stores';

nFontSizeTitleAxis = 50;
nFontSizeContent = 40;
...
SS_PlotConfusion(matRecogResult, xLabels, xTicks, yLabels, yTicks, 'Similarity of Crowdsourced Data', 1, nFontSizeTitleAxis, nFontSizeContent);

hold on;

%subplot(1,2,2);
%SS_PlotConfusion(matRecogResultNorm, xLabels, xTicks, yLabels, yTicks, 'Place Recognition Confusion Matrix (Normalized)', 2);
