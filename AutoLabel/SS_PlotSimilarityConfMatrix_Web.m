function f = SS_PlotSimilarityConfMatrix_Web(sFile)
...
SS_PlotConfusion(matRecogResult, xLabels, xTicks, yLabels, yTicks, 'Web Similarity', 1, nFontSizeTitleAxis, nFontSizeContent);
