function f = Sky_PermEvalTotal_S(fRcvTimeGap)
...
if fRcvTimeGap >= 999.0   % No receive time constraint
    sOutputFile = 'E:\\SkyEye_Backup20130801\\Simulation\\Sim_output\\Straight_TransTimeEval_NoRcvTimeCnst.csv';
else
    sOutputFile = 'E:\\SkyEye_Backup20130801\\Simulation\\Sim_output\\Straight_TransTimeEval_RcvTimeCnst.csv';
end
...
for i=1:nRangeCount
    ...
    for j=1:nSizeCount
        ...
        mResult = Sky_PermEval_S(mTrace, nRange, nSize, fRcvTimeGap);   
