function f = Sky_PermEval_D_sub(mTrace, nRange, nPacketSize, fRcvTimeGap)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if fRcvTimeGap >= 999.0    % WITHOUT time constraint
    sOutputFilePre = 'E:\\SkyEye_Backup20130801\\Simulation\\Sim_output\\Dense_40_20_ReceiverList_NoTmCnst\\Dense_Receiver';
else
    sOutputFilePre = 'E:\\SkyEye_Backup20130801\\Simulation\\Sim_output\\Dense_40_20_ReceiverList_TmCnst\\Dense_Receiver';
end
