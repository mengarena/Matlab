function f = Sky_PermEvalTotal_S_60(fRcvTimeGap)
...
if fRcvTimeGap >= 999.0   % No receive time constraint
    sOutputFile = 'E:\\SkyEye_Backup20130801\\Simulation\\Sim_output\\Straight_TransTimeEval_NoRcvTimeCnst_60.csv';
else
    sOutputFile = 'E:\\SkyEye_Backup20130801\\Simulation\\Sim_output\\Straight_TransTimeEval_RcvTimeCnst_60.csv';
end
