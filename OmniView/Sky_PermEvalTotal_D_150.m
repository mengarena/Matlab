function f = Sky_PermEvalTotal_D_150(fRcvTimeGap)
...
if fRcvTimeGap >= 999.0   % No receive time constraint
    sOutputFile = 'E:\\SkyEye_Backup20130801\\Simulation\\Sim_output\\Dense_40_20_TransTimeEval_NoRcvTimeCnst_150.csv';
else
    sOutputFile = 'E:\\SkyEye_Backup20130801\\Simulation\\Sim_output\\Dense_40_20_TransTimeEval_RcvTimeCnst_150.csv';
end
...
sFilePath = 'E:\\SkyEye_Backup20130801\\Simulation\\Sim_output\\Dense_40_20_Trace\\SkyEye_Dense';
...
for i=1:nRangeCount
    ...
    for j=1:nSizeCount
        ...
        mResult = Sky_PermEval_D_sub(mTrace, nRange, nSize, fRcvTimeGap);   
