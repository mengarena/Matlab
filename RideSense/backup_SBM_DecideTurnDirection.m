function f = backup_SBM_DecideTurnDirection(mSegBasicFeature, mUnitAcclInfo, mCellTurnGyroRows, nIdxDataType)
%
...
for i = 1:nTurnCnt
    ...
    mUnitAccl = SBM_FindPassengerUnitAccl(mUnitAcclInfo, nTurnBeginLine, nTurnEndLine);
