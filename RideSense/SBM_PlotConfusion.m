function f = SBM_PlotConfusion(CMat, xLabels, xTicks, yLabels, yTicks, sTitle, figNo)
...
%textStrings = num2str(CMat(:),'');  %# No Text in Confusion Matrix
...
hStrings = text(x(:),y(:),textStrings(:),'HorizontalAlignment','center', 'FontName','Times New Roman','FontSize', 48);      %# Plot the strings   24   12      26
...
set(gca,'XTick',1:nLenX,...                        
        ...
        'YTick',1:nLenY,...
        'YTickLabel',yTicks,...
        'TickLength',[0 0],'FontName','Times New Roman','FontSize', 48);  %36   20     30

xlabel(xLabels, 'FontName','Times New Roman','FontSize', 48);    % 44  30    36
ylabel(yLabels, 'FontName','Times New Roman','FontSize', 48);    % 44  30    36
