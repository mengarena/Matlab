function f = backupupup_SBM_GetPassengerFeature(sUniquedTmCrtTrace, sTraceInfoG, nIdxDataType)
...
%                     end
    ...
    mSegBasicFeature = SBM_DecideTurnDirection(mSegBasicFeature, mUnitAcclInfo, mCellTurnGyroRows, nIdxDataType); 
