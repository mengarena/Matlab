function f = SBM_Script_Extract_SegmentFeature_Passenger(nType)
...
for k=1:length(cellParentFolders)
    ...
    for i=3:length(Files)        
        ...
        if nTraceFile == 1 && nTraceInfoFile == 1
            SBM_GetPassengerFeature(sPsgTraceFile, sPsgTraceInfoFile, nIdxDataType);            
            %SBM_GetPassengerFeatureS(sPsgTraceFile, sPsgTraceInfoFile, nIdxDataType);
            break;
        end
    end
