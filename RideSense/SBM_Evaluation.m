function f = SBM_Evaluation(mSelectedFeatures, nUseFilter, featureCombIdx)
% This one is called by SBM_Script_EvaluationTotal, so use this one,
% instead of SBM_Evaluation_Exp
%
...
if nUseFilter == 1
%    sEvaluationResultPrefix = 'E:\SensorMatching\Data\SchoolShuttle\Evaluation20160318\EvRet';
else
%    sEvaluationResultPrefix = 'E:\SensorMatching\Data\SchoolShuttle\Evaluation_NoFilter\EvRet';    
end

%sEvaluationResultPrefix = 'E:\SensorMatching\Data\SchoolShuttle\Evaluation20160503_5Route_SingleFeature\EvRet'; 
sEvaluationResultPrefix = 'E:\SensorMatching\Data\SchoolShuttle\Evaluation20160506_RawPcaPca2\EvRet'; 
...
sEvaluationResultFile = [sEvaluationResultFile '_' num2str(featureCombIdx) '.csv'];
        ...
        for k = 1:2   % 1--Hand, 2--Pocket
            ...
            for nCombLen = 1:nSegCnt  % Number of segments in each combination
                ...
                for nSrcSegNo = 1:nSegCnt
                    ...
                    % Input: Basic Feature;  Detailed Feature of passenger
                    % trace
                    ...
                    [MatchedRouteNo MatchedTraceNo MatchedSegCnt MatchedSegSrc MatchedSegDst nRawRefCombCnt nFeatureMatchingRefCombCnt fMatchedRefPsgDist] = SBM_MatchTrace(i,j,k,nSrcSegNo, nDstSegNo, mPsgBF, mPsgDF, mSelectedFeatures, fPsgTotalTravelDuration, fPsgBeginBaro, fPsgEndBaro, nUseFilter);
