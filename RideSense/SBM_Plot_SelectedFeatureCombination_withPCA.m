function f = SBM_Plot_SelectedFeatureCombination_withPCA(nFeatureComnIdx)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The index for the mCellSelectedFeatures is different from the index in SBM_SelectFeatureCombination
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
mCellSelectedFeatures{31} = [11:14, 31:34];   % Freequency
...
mSelectedFeatures = mCellSelectedFeatures{nFeatureComnIdx};
