function f = SBM_Evaluation_SingleFeature(mSelectedFeatures, nUseFilter, featureIdx)
...
sEvaluationResultPrefix = 'E:\SensorMatching\Data\SchoolShuttle\Evaluation20160430\EvRet'; 
...
sEvaluationResultFile = [sEvaluationResultFile '_' num2str(featureIdx) '.csv'];
