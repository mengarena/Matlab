function f = SBM_Script_EvaluationTotal_PCA_Param_YellowFeature_B()
...
mFeatures = [118:162, 164:168, 170:171];   %% Features, Feature 111, 117, 163, 169 are excluded

for i = 1:length(mFeatures)
    mSelectedFeatures = [];
    mSelectedFeatures(1) = mFeatures(i);
    fprintf('============>Evaluating Feature Set [%d]......\n', mFeatures(i));
    
    SBM_Evaluation_Yellow(mSelectedFeatures, nUseFilter, mFeatures(i));
end
