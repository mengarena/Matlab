function f = SBM_EvaluationS(mSelectedFeatures, nUseFilter)
...
if nUseFilter == 1
    sEvaluationResultPrefix = 'E:\SensorMatching\Data\SchoolShuttle\Evaluation20160226\EvRet';
else
    ...
    for j = 1:3  % Trace
        ...
        for k = 1:2   % 1--Hand, 2--Pocket
            ...
            if k == 1  % hand
                ...
                sBFFilename = 'hand_Uniqued_TmCrt_TraceBFs.csv';
                sDFFilename = 'hand_Uniqued_TmCrt_TraceDFs.csv';
            else % k == 2 % pocket
                sInfoGFile = [sParentFolder '\pantpocket_Uniqued_TmCrt_InfoG.csv'];
                sBFFilename = 'pantpocket_Uniqued_TmCrt_TraceBFs.csv';
                sDFFilename = 'pantpocket_Uniqued_TmCrt_TraceDFs.csv';
            end
