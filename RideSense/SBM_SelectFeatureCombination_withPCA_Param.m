function f = SBM_SelectFeatureCombination_withPCA_Param(startFeatureIdx, endFeatureIdx)
...
%sParentFolder = 'E:\SensorMatching\Data\SchoolShuttle\Evaluation20160426';
sParentFolder = 'E:\SensorMatching\Data\SchoolShuttle\Evaluation20160503_Yellow_SingleFeature';
...
sSelectFeatureCombWhichWhereWhen = 'E:\SensorMatching\Data\SchoolShuttle\SelectFeatureCombination20160503_Yellow_SingleFeature\WhichWhereWhen.csv';
fid3W = fopen(sSelectFeatureCombWhichWhereWhen, 'w');

sSelectFeatureCombWhichWhere = 'E:\SensorMatching\Data\SchoolShuttle\SelectFeatureCombination20160503_Yellow_SingleFeature\WhichWhere.csv';
fidWhichWhere = fopen(sSelectFeatureCombWhichWhere, 'w');

sSelectFeatureCombWhichWhen = 'E:\SensorMatching\Data\SchoolShuttle\SelectFeatureCombination20160503_Yellow_SingleFeature\WhichWhen.csv';
fidWhichWhen = fopen(sSelectFeatureCombWhichWhen, 'w');

sSelectFeatureCombWhich = 'E:\SensorMatching\Data\SchoolShuttle\SelectFeatureCombination20160503_Yellow_SingleFeature\Which.csv';
...
%for i = 1:length(mCellSelectedFeatures)
for i = startFeatureIdx:endFeatureIdx
