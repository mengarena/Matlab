function f = SBM_Evaluation_Yellow(mSelectedFeatures, nUseFilter, featureCombIdx)
...
sStatRefFile = 'E:\SensorMatching\Data\SchoolShuttle\Stat\StatRef_Yellow.csv';
...
sEvaluationResultPrefix = 'E:\SensorMatching\Data\SchoolShuttle\Evaluation20160506_Yellow_SingleFeature\EvRet'; 
        ...
        for k = 1:2   % 1--Hand, 2--Pocket
            ...
            for nCombLen = 1:nSegCnt  % Number of segments in each combination
                ...
                for nSrcSegNo = 1:nSegCnt
                    ...
                    [MatchedRouteNo MatchedTraceNo MatchedSegCnt MatchedSegSrc MatchedSegDst nRawRefCombCnt nFeatureMatchingRefCombCnt fMatchedRefPsgDist] = SBM_MatchTrace_Yellow(i,j,k,nSrcSegNo, nDstSegNo, mPsgBF, mPsgDF, mSelectedFeatures, fPsgTotalTravelDuration, fPsgBeginBaro, fPsgEndBaro, nUseFilter);
